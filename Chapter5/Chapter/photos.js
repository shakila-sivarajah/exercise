...
/* add src value to img elements based on order specified in photoOrder array */
...
function previewFive(){
	...
	// clone figure element for the fifth image and edit to be frst image
	...
	// add appropriate src value to two new img elements
