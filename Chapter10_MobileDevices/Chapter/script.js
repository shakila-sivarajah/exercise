...
function removeTouchListener() {
	this.removeEventListener("touchmove", moveDrage, false);
...
function loadDirections(string) {
   ...
   if (typeof google !== 'object') {
       ...
       script.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyAj8oMz6LljeKJW-PZDdCneD4J3Glzv8LU&callback=geoTest";
